...
def build_bond_list(coordinates, max_bond=1.5, min_bond=0):
    ...
    bonds : dict
        ...
        and the value of that key is the distance
        between the two atoms.
    """
    #make sure coordinate list is not empty
    if (coordinates.ndim and coordinates.size) == False:
        raise ValueError("The coordinate list must not be empty.")
